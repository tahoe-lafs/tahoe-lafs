...
import json
import codecs
from typing import Any, Iterator, Optional, Union, AnyStr
...
def bytes_to_unicode(any_bytes: bool, obj: object) -> object:
...
class UTF8BytesJSONEncoder(json.JSONEncoder):
    ...
    """
    def encode(self, o: object, **kwargs: Any) -> str:
