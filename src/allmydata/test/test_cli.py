...
class Help(unittest.TestCase):
    def failUnlessInWithoutSpaces(self, x, y):
        ...
        self.failUnlessIn(x.replace(" ", "").replace("\n", ""),
                          y.replace(" ", "").replace("\n", ""))
    ...
    def test_mv(self):
        ...
        self.failUnlessInWithoutSpaces("Use 'tahoe mv' to move files", help)

    def test_cp(self):
        help = str(cli.CpOptions())
        self.failUnlessIn("[options] FROM.. TO", help)
        self.failUnlessInWithoutSpaces("Use 'tahoe cp' to copy files", help)

    def test_ln(self):
        help = str(cli.LnOptions())
        self.failUnlessIn("[options] FROM_LINK TO_LINK", help)
        self.failUnlessInWithoutSpaces("Use 'tahoe ln' to duplicate a link", help)

    def test_mkdir(self):
        help = str(cli.MakeDirectoryOptions())
        self.failUnlessIn("[options] [REMOTE_DIR]", help)
        self.failUnlessInWithoutSpaces("Create a new directory", help)
    ...
    def test_debug_trial(self):
        ...
        self.failUnlessInWithoutSpaces("The 'tahoe debug trial' command uses the correct imports", help)

    def test_debug_flogtool(self):
        options = debug.FlogtoolOptions()
        help = str(options)
        self.failUnlessIn(" [global-options] debug flogtool ", help)
        self.failUnlessInWithoutSpaces("The 'tahoe debug flogtool' command uses the correct imports", help)
