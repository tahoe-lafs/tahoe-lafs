...
class ServerTest(ServerMixin, ShouldFailMixin):
    ...
    def test_declares_available_space(self):
        server = self.create("test_declares_available_space")
        aa = server.get_accountant().get_anonymous_account()
    ...
    def test_reserved_space(self):
        ...
        def call_get_disk_stats(whichdir, reserved_space=0):
            ...
            return {
              ...
              'avail': max(15000 - ns.allocated - reserved_space, 0),
            }
        ...
        def _allocated( (already, writers) ):
            ...
            def _increase_allocated(ign):
                # this changes the amount reported as available by call_get_disk_stats
                ns.allocated = 1001 + OVERHEAD + LEASE_SIZE
            d2.addCallback(_increase_allocated)
