...
class HTTPSNurlTests(SyncTestCase):
    ...
    def test_spki_hash(self):
        ...
        The expected SubjectPublicKeyInfo bytes were extracted from the implementation of `get_spki_hash` after its result matched the expected value generated by the command above.
